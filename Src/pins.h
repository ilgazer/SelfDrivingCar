...
#define INDICATOR_STOP_PORT GPIOA
#define INDICATOR_STOP_PIN  9


#define INDICATOR_AUTO_PORT GPIOB
#define INDICATOR_AUTO_PIN 7


#define INDICATOR_OVERRIDE_PORT GPIOC
#define INDICATOR_OVERRIDE_PIN 7
